...
sealed class Destination(
    ...
    object List : Destination("list", R.string.fragment_repo_list_label)
    object Details : Destination("details", R.string.fragment_repo_details_label) {
...
val screens = listOf(Destination.List, Destination.Details)
